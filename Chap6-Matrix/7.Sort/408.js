/**
 * Problem: Write a function to sort elements in a row of matrix
 * in descending order from the left to the right
 *
...
function mergeSort(a) {
  ...
  return sortingAndMerging(mergeSort(left), mergeSort(right));
}
/**
 *
 * @param {Array} left
 * @param {Array} right
 */
function sortingAndMerging(left, right) {
  /**
   * + Descending order
