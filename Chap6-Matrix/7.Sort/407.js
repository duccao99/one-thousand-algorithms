/**
 * Problem: Write a function to sort the element in a row
 * of matrix in ascending order from the left to the right
 *
 ...
 * + 3| 3 2 1
 *
 * - Ascending order from the left to the right
 * + 0| 1 2 3
 * + 3| 1 2 3
 *
 * - ret
